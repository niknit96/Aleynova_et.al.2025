...
tax_meta$Class_Family = paste0(tax_meta$Class, "; ", tax_meta$Family)
tax_meta = tax_meta[,c("Kingdom", "Phylum", "Class", "Order", "Family", "Class_Family", "Class_Genus", "Genus", "Species")]
...
ggsave("../fig 1a. Shannon (Tree_parts) (16S).png", width=3, height=4, dpi=400)
```
## Shannon (Season)
```{r fig.width=5, fig.height=6}
...
t1$plot_alpha(measure = "Shannon") +
	scale_y_continuous(breaks = c(0,1,2,3,4,5,6), limits = c(2,6))
ggsave("../fig 1c. Shannon (Tree_specimens) (16S).png", width=3, height=4, dpi=400)
```
...
ggsave("../fig 1d. Bray-curtis (Tree_parts) (16S).png", width=4, height=4, dpi=400)
```
...
ggsave("../fig 1f. Bray-curtis (Tree_specimens) (16S).png", width=4, height=4, dpi=400)
```
...
write.table(ASV, "../Table S4. ASVs (16S).txt", quote = F, sep = "\t")
```
...
path = "../fig 2a. Tree_parts bar plot (Class) (16S)"
order_x = c("Branch", "Needles", "Fresh_wood")
order_tax = c("c__Alphaproteobacteria", "c__Gammaproteobacteria", "c__Actinobacteria",
		"c__Bacteroidia", "c__Bacilli", "c__Acidobacteriae", "c__Armatimonadia", "c__Clostridia", "c__Myxococcia", "Others")
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2d. Tree_parts bar plot (Order) (16S)"
order_x = c("Branch", "Needles", "Fresh_wood")
order_tax = c("o__Rhizobiales", "o__Burkholderiales", "o__Sphingomonadales", "o__Propionibacteriales", 
		"o__Micrococcales", "o__Enterobacterales", "o__Acetobacterales", 
		"o__Cytophagales", "o__Pseudomonadales", "o__Staphylococcales", "Others")
barplot(order_x, order_tax, path)
```
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2g. Tree_parts bar plot (Family) (16S)"
order_x = c("Branch", "Needles", "Fresh_wood")
order_tax = c("f__Beijerinckiaceae", "f__Sphingomonadaceae", "f__Comamonadaceae",
		"f__Propionibacteriaceae", "f__Enterobacteriaceae", "f__Acetobacteraceae", 
		"f__Microbacteriaceae", "f__Micrococcaceae", "f__Staphylococcaceae", "f__Hymenobacteraceae", "Others")
barplot(order_x, order_tax, path)
```
...
t1$plot_venn()
ggsave("../fig 3a. Tree_parts venn diagramm (ASV) (16S).png", width=5, height=5, dpi=400)
```
```{r}
datatable(t1$data_details, options = list(scrollX = TRUE, scrollY = TRUE))
write.table(t1$data_details, sep = "\t", quote = FALSE, file="Tree_parts venn diagramm (ASV) (16S).txt")
```
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2b. Season bar plot (Class) (16S)"
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2e. Season bar plot (Order) (16S)"
order_x = c("Summer", "Winter")
order_tax = c("o__Rhizobiales", "o__Burkholderiales", "o__Sphingomonadales", "o__Propionibacteriales", 
		"o__Micrococcales", "o__Enterobacterales", "o__Acetobacterales", 
		"o__Cytophagales", "o__Pseudomonadales", "o__Staphylococcales", "Others")
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2h. Season bar plot (Family) (16S)"
order_x = c("Summer", "Winter")
order_tax = c("f__Beijerinckiaceae", "f__Sphingomonadaceae", "f__Comamonadaceae",
		"f__Propionibacteriaceae", "f__Enterobacteriaceae", "f__Acetobacteraceae", 
		"f__Microbacteriaceae", "f__Micrococcaceae", "f__Staphylococcaceae", "f__Hymenobacteraceae", "Others")
...
t1 <- trans_venn$new(ven, ratio = "seqratio")
t1$plot_venn()
ggsave("../fig 3b. Season venn diagramm (ASV) (16S).png", width=5, height=5, dpi=400)
```
```{r}
datatable(t1$data_details, options = list(scrollX = TRUE, scrollY = TRUE))
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2c. Tree_specimens bar plot (Class) (16S)"
order_x = c("Pj_1", "Pj_2")
order_tax = c("c__Alphaproteobacteria", "c__Gammaproteobacteria", "c__Actinobacteria",
		"c__Bacteroidia", "c__Bacilli", "c__Acidobacteriae", "c__Armatimonadia", "c__Clostridia", "c__Myxococcia", "Others")
barplot(order_x, order_tax, path)
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2f. Tree_specimens bar plot (Order) (16S)"
order_x = c("Pj_1", "Pj_2")
order_tax = c("o__Rhizobiales", "o__Burkholderiales", "o__Sphingomonadales", "o__Propionibacteriales", 
		"o__Micrococcales", "o__Enterobacterales", "o__Acetobacterales", 
		"o__Cytophagales", "o__Pseudomonadales", "o__Staphylococcales", "Others")
...
```
```{r fig.width=5, fig.height=6}
path = "../fig 2i. Tree_specimens bar plot (Family) (16S)"
order_x = c("Pj_1", "Pj_2")
order_tax = c("f__Beijerinckiaceae", "f__Sphingomonadaceae", "f__Comamonadaceae",
		"f__Propionibacteriaceae", "f__Enterobacteriaceae", "f__Acetobacteraceae", 
		"f__Microbacteriaceae", "f__Micrococcaceae", "f__Staphylococcaceae", "f__Hymenobacteraceae", "Others")
...
t1 <- trans_venn$new(ven, ratio = "seqratio")
t1$plot_venn()
ggsave("../fig 3c. Tree_specimens venn diagramm (ASV) (16S).png", width=5, height=5, dpi=400)
```
```{r}
datatable(t1$data_details, options = list(scrollX = TRUE, scrollY = TRUE))
write.table(t1$data_details, sep = "\t", quote = FALSE, file="Tree_specimens venn diagramm (ASV) (16S).txt")
```
...
p1
ggsave("../fig 4. core (16S).png", width=8, height=3, dpi=400)
```
...
png("../fig 5. Heatmap Tree_parts (16s).png", width=7, height=6, units = "in", res=400)
htmp = psq %>%
...
df <- ko_table %>% 
	...
	group_by(level1, level2, level3, level4) %>%
	reframe(abund = sum(abund)) %>%
	mutate(level2 = ifelse(level4 %in% df_top$level4, level2, paste0("OTHER ", level2))) %>%
	mutate(level3 = ifelse(level2 %in% df_top$level2, level3, NA)) %>%
	mutate(level4 = ifelse(level2 %in% df_top$level2, level4, NA)) %>%
	group_by(level1, level2, level3, level4) %>%
	reframe(abund = sum(abund)) %>%
	ungroup() %>%
	filter(level1 != "No PGPT", level2 != "PUTATIVE_PGPTs", level2 != "OTHER PUTATIVE_PGPTs") %>%
	# na.omit() %>%
...
ggsave("../fig 6. Functional analysis (16S).png", width=11, height=6, dpi=400, scale = 2)
```

# Sankey diagramm (Other)
```{r }
df_top <- ko_table %>% 
	select(level1, level2, level3, level4, abund) %>%
	group_by(level1, level2, level3, level4) %>%
...
df <- ko_table %>% 
	...
	group_by(level1, level2, level3, level4) %>%
	reframe(abund = sum(abund)) %>%
	mutate(level2 = ifelse(!(level4 %in% df_top$level4), level2, paste0(level1, " TOP 15"))) %>%
	mutate(level3 = ifelse(level2 %in% df_top$level2, level3, NA)) %>%
	mutate(level4 = ifelse(level2 %in% df_top$level2, level4, NA)) %>%
	group_by(level1, level2, level3, level4) %>%
	reframe(abund = sum(abund)) %>%
...
dagg <- df %>%
  ...
  reframe(perc = sum(perc)) %>%
  mutate(perc_PGPT = max(perc)) %>%
  mutate(perc = round(perc/perc_PGPT*100, digits=2)) %>%
  select(node, perc) 
...
ggsave("../fig S2. Functional analysis (other) (16S).png", width=13, height=11, dpi=400, scale = 2)
```
...
difab$tidy_dataset()
t1 <- trans_diff$new(dataset = difab, method = "ancombc2", group = "Tree_parts", fix_formula = "Tree_parts", taxa_level = "level5", pairwise = TRUE)
res_convert <- data.frame()
tmp_res = t1$res_diff_raw$res_pair
for(i in seq_len(nrow(tmp_res))){
	taxon_data <- tmp_res[i, ]
...
Needles = unique(filter(res, Factors == "Tree_partsNeedles" & lfc > 0 & passed_ss == T & diff == T | 
	Factors == "Tree_partsFresh_wood_Tree_partsNeedles" & lfc < 0 & passed_ss == T & diff == T )$Taxa )

Fresh_wood = unique(filter(res, Factors == "Tree_partsFresh_wood" & lfc > 0 & passed_ss == T & diff == T | 
	Factors == "Tree_partsFresh_wood_Tree_partsNeedles" & lfc > 0 & passed_ss == T & diff == T )$Taxa)

Branch = unique(filter(res, Factors == "Tree_partsFresh_wood" & lfc < 0 & passed_ss == T & diff == T  | 
	Factors == "Tree_partsNeedles" & lfc < 0 & passed_ss == T & diff == T )$Taxa )
