...
write.table(Perm@permanova, sep = "\t", quote = FALSE, file="./PERMANOVA_Organ_material (ITS).txt")
...
write.table(Perm@permanova, sep = "\t", quote = FALSE, file="./PERMANOVA_Season (ITS).txt")
...
write.table(Perm@permanova, sep = "\t", quote = FALSE, file="./PERMANOVA_location (ITS).txt")