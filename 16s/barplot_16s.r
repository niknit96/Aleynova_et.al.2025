...
ggsave("Figure 1a. barplot_Class_Organ_16s.png", width = 17, height = 15)
...
ggsave("Figure 6a. barplot_Class_Season_16s.png", width = 16, height = 15)
#
...
ggsave("Figure 9a. barplot_Class_Plant_16s.png", width = 17, height = 15)
