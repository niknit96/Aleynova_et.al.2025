...
filter_genera = transform_sample_counts(physeq_16s, function(x) x / sum(x) * 100)
...
png("Figure 1c. Upset_Organ_material (16s).png",  width = 8, height = 6, units = "in", res = 300)
...
png("Figure 6c. Upset_Season (16s).png",  width = 8, height = 6, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
...
colnames(Upset_genus_.txt) = c("Genus", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Table S14.txt")
Upset_genus_.txt = left_join(Upset_genus_.txt, tax_suppl, by = "Genus")
Upset_genus_.txt = Upset_genus_.txt[,c("Where present", "Amplicon sequence variant", "Genus", "Family", "Order", "Class", "Phylum", "Kingdom")]
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Table S13.txt")
#
...
png("Figure 9c. Upset_Plant(16s).png",  width = 10, height = 8, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
